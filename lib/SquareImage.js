...
var SquareImage = function (_React$Component) {
  ...
  _createClass(SquareImage, null, [{
    ...
    get: function get() {
      return {
        ...
        parentWidth: _react2.default.PropTypes.func
      };
    }
  }, {
    key: 'defaultProps',
  ...
  _createClass(SquareImage, [{
    ...
    value: function resize() {
      ...
      var cap = function cap(min, a, max) {
        return Math.min(Math.max(min, a), max);
      };
      var width = function width() {
        return cap(_this2.props.minWidth, _this2.props.parentWidth() / Math.floor(_this2.props.parentWidth() / _this2.props.minWidth), _this2.props.maxWidth);
      };
